...
public class DataManager extends FolderManager
{
	...
	public static long MAX_DATA_SIZE = setFromProperty("max.data.display.size", 2097152L);
	 ...
	 * Static init methods
	 *================================================================*/
	 private static long setFromProperty(String property, long defaultValue) 
	 {
	 	try
		{
			long value;
			value = Long.parseLong(wbProperties.getProperty(property));
			logger.debug("Set " + property + " to " + value);
			return value;
		}
		catch(Exception e)
		{
			logger.error("Error parsing property " + property +  ". " + e.toString() +
