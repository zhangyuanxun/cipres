...
<s:if test="%{hasFolderTasks()}">
  ...
  <s:form name="selectTasks" action="task" theme="simple">
    ...
    <div class="form-group">
      ...
      -->
      <s:submit cssClass="btn btn-primary" value="Kill Selected" method="cancelSelected" onclick="return confirm_form()"/>
      <s:submit cssClass="btn btn-primary" value="Delete Selected" method="deleteSelected" onclick="return confirm_delete_selected()"/>
    </div>
  </s:form>
</s:if>
<s:else>
