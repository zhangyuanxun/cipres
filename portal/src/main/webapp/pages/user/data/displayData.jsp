...
<body>
  ...
  <div class="form-horizontal">
	...
	<s:if test="%{currentDataItemIsMine()}">
		<div class="form-group">
			<label class="col-xs-2 control-label">Shared</label>
			<div class="col-xs-10">
				<span class="form-control">
					<s:property value='%{currentDataItemIsShared() ? "yes" : "no"}'/>
				</span>
			</div>
		</div>
	</s:if>
  ...
  <s:if test="%{hasSourceDocument()}">
    <div class="data-content section">
	  ...
	  <s:url id="editorUrl" action="editDocument" method="input" includeParams="none"/>
	  <s:a cssClass="btn btn-link" href="%{editorUrl}">Edit Data</s:a>
