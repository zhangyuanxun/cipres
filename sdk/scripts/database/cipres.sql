...
--
-- Host: mysql2.sdsc.edu    Database: cipres_copy
-- ------------------------------------------------------
...
CREATE TABLE `source_documents` (
  ...
  UNIQUE KEY `SD_SIGNATURE_INDEX` (`SIGNATURE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `task_output_source_documents` (
  ...
  KEY `SOURCE_DOCUMENT_ID` (`SOURCE_DOCUMENT_ID`),
  CONSTRAINT `task_output_source_documents_ibfk_1` FOREIGN KEY (`SOURCE_DOCUMENT_ID`) REFERENCES `source_documents` (`SOURCE_DOCUMENT_ID`),
  CONSTRAINT `task_output_source_documents_ibfk_2` FOREIGN KEY (`OUTPUT_ID`) REFERENCES `task_output_parameters` (`OUTPUT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-10-17 11:23:33
