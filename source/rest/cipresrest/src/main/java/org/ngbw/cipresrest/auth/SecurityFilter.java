...
public class SecurityFilter implements ContainerRequestFilter 
{
    ...
    public void  filter(ContainerRequestContext requestContext) throws IOException
	{
		...
		boolean fileapiEnabled = Boolean.parseBoolean(Workbench.getInstance().getProperties().getProperty("fileapi.enabled"));
		...
		*/
		...
		if (fileapi && !fileapiEnabled)
		{
			throw new NotFoundException("The file api isn't implemented yet.");
		}
