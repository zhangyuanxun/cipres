...
public class NonJerseyAuthFilter implements Filter 
{
	...
	private static boolean tusEnabled = Boolean.parseBoolean(Workbench.getInstance().getProperties().getProperty("tus.enabled"));
	        ...
	        throws ServletException, IOException
	{
		...
		if (!tusEnabled)
		{
			sendError(response, HttpServletResponse.SC_NOT_FOUND, "The file api isn't implemented yet.");
			return;
		}
