...
def main(argv):
    try:
        ...
        if prepare_target:
            ...
            cipres_java_client_build_src_dir = path.join(module_build_dir, "cipres_java_client", "src")
            cipres_java_client_conf_src_dir = path.join(conf_dir, "cipres_java_client", "src")
            ...
            if path.exists(cipres_java_client_conf_src_dir):
                cipres.copy_tree(None, cipres_java_client_conf_src_dir, cipres_java_client_build_src_dir)
        ...
        if deploy_target:
            ...
            python_cipres_dir = path.join(module_dir,  "python_cipres")
            ...
            shutil.copy2(path.join(module_build_dir, "cipresrest", "target", "classes", "pycipres.conf"), 
                path.join(test_data_dir, "pycipres.conf"))
