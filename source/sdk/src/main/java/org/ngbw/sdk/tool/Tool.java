...
public class Tool {
	...
	public RenderedCommand renderCommand(Map<String, List<String>> parameters)
	{
	...
	*/
	public RenderedCommand validateCommand(Map<String, String> parameters, Map<String, List<String>> inputFileParams)
	{
		CommandRenderer cr = getCommandRenderer();
		...
		/*
			...
			full command line.
		*/
		Map<String, List<String>> parametersCopy = new HashMap<String, List<String>>(parameters.size());
		for (Map.Entry<String, String> entry: parameters.entrySet())
		{
			...
			parametersCopy.put(entry.getKey(), copy);
		}
		for (Map.Entry<String, List<String>> entry : inputFileParams.entrySet())
		{
			List<String> copy = new ArrayList<String>();
	...
	public String disabled()
	{
		...
		if (toolConfig.isActive() == false)
		{
			return "The specified tool, " + this.toolId + ", is not in the active tool registry." +
				"  The tool is no longer available for use.";
		}
	...
	*/
		...
		throws DisabledResourceException
	{
		...
		// This message will never be seen so long as you don't have PSUEDO resources in your registry.
		throw new DisabledResourceException("Internal configuration error.  Missing information to " +
