...
public class RenderedCommand
{
	...
	private Map<String, List<String>> inputFileMap = new HashMap<String, List<String>>();
	...
	public RenderedCommand(String[] command, Map<String, List<String>> inputFileMap, Map<String, String> outputFileMap)
	{
	 ...
	 * @return inputFileMap
	 */
	public Map<String, List<String>> getInputFileMap()
	{
		return inputFileMap;
	}
	 ...
	 * @param inputFileMap
	 */
	public void setInputFileMap(Map<String, List<String>> inputFileMap)
	{
		this.inputFileMap = inputFileMap;
	}
