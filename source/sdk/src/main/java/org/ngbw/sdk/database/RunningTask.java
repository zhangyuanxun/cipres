...
public class RunningTask extends Row implements Comparable<RunningTask> {
	 ...
	 */
	public static List<RunningTask> findReadyToSubmit(String submitter, Boolean alreadyTried, boolean locked) throws Exception
	{
		String clause = "";
	 ...
	 */
	public static List<RunningTask> findRunningTaskBySubmitterAndStatus(String submitter, String status) throws IOException, SQLException
	{
	...
	public static List<RunningTask> findRunningTaskBySubmitterAndStatus(
			...
			String clause,
			Boolean locked) throws IOException, SQLException
	{
	...
	public static List<RunningTask> findAllRunningTasks() throws IOException, SQLException
	{
		return findRunningTask(new NotNullCriterion("JOBHANDLE", Types.VARCHAR));
	}
