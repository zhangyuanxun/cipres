...
// If page has a control with id="cipres-editor" (it should be a textarea control)
// this installs enableTab handler on the texteditor so that user can insert tabs
// instead of tab having the default field advance behavior.  Only handles one such
// textarea on a page.
$(document).ready(function() {  enableTab('cipres-editor'); }  );
